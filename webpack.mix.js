...
let staticPath = "src/siteplan/static/mix/build";
let resourcesPath = "src/siteplan/fe";
...
mix.setPublicPath("src/siteplan/static/mix/build"); // Path where mix-manifest.json is created
